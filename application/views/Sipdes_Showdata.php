...
<div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Pegawai</h3><br>
               <!-- SEARCH FORM -->
    <form class="form-inline ml-1" action="<?php echo base_url('index.php/SipdesMaster/search/'); ?>" method="post">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                        ...
                        <tr>
                            <td><?php echo $no++?></td>
                            <td><?php echo $p->SNama_Penduduk?></td>
                            <td><?php echo $p->SNomor_Hp?></td>
                            <td><?php echo $p->SJabatan?></td>
                            <td><a href="<?php echo base_url('index.php/SipdesDashboard/Editdata/'.$p->idSData_penduduk) ?>" class="btn btn-primary">Edit</a>
                            
                            <a href="<?php echo base_url('index.php/SipdesMaster/deletedata/'.$p->idSData_penduduk) ?>" class="btn btn-primary">Hapus</a>
                        </td>
