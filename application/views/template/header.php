...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url()?>index.php/SipdesDashboard" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url()?>index.php/SipdesDashboard" class="brand-link">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <div class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url()?>index.php/SipdesDashboard" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/SipdesDashboard/inputpenduduk" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Input Data Pegawai</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/SipdesDashboard/showdataall" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>index.php/SipdesDashboard/input_pengumuman" class="nav-link"> 
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Kirim Pengumuman
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/SipdesDashboard/showinbox" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/SipdesDashboard/showpengumuman" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
